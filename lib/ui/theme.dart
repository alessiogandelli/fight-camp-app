...
abstract final class AppText {
  ...
  static const TextStyle overline = TextStyle(
      fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 1.4, color: AppColors.mut);

  /// Even smaller label used inside dense cards/stats.
  static const TextStyle micro = TextStyle(
      fontSize: 9.5, fontWeight: FontWeight.w700, letterSpacing: 1.2, color: AppColors.mut);
  ...
  static const TextStyle statValue = TextStyle(
      fontSize: 22, fontWeight: FontWeight.w800, fontFeatures: [FontFeature.tabularFigures()]);
}
...
ThemeData buildTheme() {
  ...
  return base.copyWith(
    ...
    dialogTheme: DialogThemeData(
      ...
      titleTextStyle: const TextStyle(color: AppColors.ink, fontWeight: FontWeight.w700, fontSize: 16),
      contentTextStyle: const TextStyle(color: AppColors.mut, fontSize: 14, height: 1.4),
    ),
  );
}
